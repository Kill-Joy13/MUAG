...
export var wallSound = new soundFile("wallhit.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("new ball hit .mp3");
...
export var adventureMusic = new soundFile("PONG.mp3");
